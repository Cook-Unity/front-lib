...
const FinalSteps = ({ mealDetail, isLoading }) => {
  ...
  <div className={styles.finalSteps}>
        <div className={styles.finalSteps, isLoading ? styles.finalSteps : null }>
      <div className={styles.cooking}>
        <h2 className={classnames({ loading: isLoading })}>
          Heating Instructions
        </h2>
        {ovenSteps && (
          <div className={styles.oven, isLoading ? styles.finalSteps : null }>
            <h4>
              In the Oven
              {!isLoading && <span> (Recommended)</span>}
            </h4>
            <div className={styles.steps, isLoading ? styles.finalSteps : null }>
        ...
        {microwaveSteps && (
          <div className={styles.microwave, isLoading ? styles.finalSteps : null }>
