export const defaultProps = {
  mealDetail: {
    bannerpic: 'ED1_56602498751913.jpg',
    calories: 562,
    category: 8,
    chefFirstname: 'Ali',
    chefId: '73841',
    ...
    cookingSteps: {
      ...
      oven_steps:
        '1. Preheat to 350F. Remove sleeve and film.Heat up for 15-20 mins or until heated through.',
      oven_steps_without_sealing: null
    },
    id: 3169,
    image: '/t/u/turkey_sweet.jpg',
    imageFullUrl:
      'https://d1ureao5dcqpo4.cloudfront.net/media/catalog/product/cache/x600/t/u/turkey_sweet.jpg',
    ingredientsData: [
      {
        componentCode: 'Coconut Milk',
        description:
          'Coconut milk is a vegan, lactose-free, environmentally friendly beverage that can substitute dairy milk. It contains almost the same amount of protein per serving and has a creamy special savory taste that enriches every dish without adding any cholesterol. Calcium enriched options are great for vegans to help maintain bones and teeth healthy!',
        filename: 'basil.jpg',
        id: 187,
        image:
    ...
    logopic: 'inspiralized-logo-428360.jpg',
    manufacturers: null,
    mealStory:
      'A salmon meal worthy to make your day diverse! Salmon is a fish you can enjoy because of its low mercury content. The fish and asparagus is oven- baked with garlic and parsley.',
    meat_type: 'Turkey',
  ...
  onChefClick: () => console.log('hola'),
  isLoading: false,
  isOrdering: false,
  addProduct: false,
  toggleReviewsModal: () => console.log('hola')
}
