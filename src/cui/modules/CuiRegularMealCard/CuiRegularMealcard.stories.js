...
const meal = {
  ...
  feature: null,
  weight: 1,
  filter_by: ['beef', 'meat', 'high fat', 'high protein', 'nut free', 'asian'],
  cuisines: ['asian'],
  ...
  quantity: 0,
  imageUrl:
    'https://d1ureao5dcqpo4.cloudfront.net/media/catalog/product/cache/x1200/i/r/irvin-braised-short-ribs.jpeg',
  full_path_meal_image:
    'https://d1ureao5dcqpo4.cloudfront.net/media/catalog/product/cache/x1200/i/r/irvin-braised-short-ribs.jpeg',
  full_path_chef_image:
    'https://d1ureao5dcqpo4.cloudfront.net/media/avatar/irvin20750.jpg',
  protein_type: 'Beef',
  secondary_image: null,
  gif: null,
  specifications_detail: [null, null, null],
  sorting: {
    DEFAULT: 515,
    ALL: 1,
    FOR_YOU: 1
