            ...
            >
              ...
              {mealStatus === MEAL_STATUS.AVAILABLE &&
                orderStatus === ORDER_STATUS.SKIP && (
                  <Button
                    ...
                    size="medium"
                    type="button"
                    onClick={() => unskipAndAddCallback(date)}
                  >
                    Unskip & Add
                  </Button>
                )}
              {mealStatus === MEAL_STATUS.AVAILABLE &&
                orderStatus === ORDER_STATUS.CONFIRMED && (
                  <div
                    className={`cui-addmeals-status cui-addmeals-status-${mealStatus}`}
                  >
                    ORDER PROCESSED
                  </div>
                )}
...
CuiAddMeals.defaultProps = {
  description:
    'You can add this dish to any one of your upcoming orders, even if you skipped it.',
